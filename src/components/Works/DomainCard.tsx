...
const DomainCard = () => {
    const customStyle = {
        ...
        '--text-weight': 400,
        color: 'var(--text-color)', // Using the custom variable
        fontSize: 'var(--text-size)', // Applying size
        lineHeight: 'var(--text-line-height)', // Applying line-height
        letterSpacing: 'var(--text-letter-spacing)', // Applying letter-spacing
        fontWeight: 'var(--text-weight)', // Applying weight
      };
  return (
    <div className="window-card min-w-96">
      ...
      <div className="bg-[var(--ds-background-100)] my-2">
        <p className="font-semibold text-xs md:text-sm">
          Software Developer
          {", "}
          <span className="text-[hsl(var(--muted-foreground))] text-xs md:text-sm mt-1">{`2024`}</span>
        </p>
        <div
          className="bg-background-100 relative w-fit origin-bottom-left rounded-full px-4 py-3 shadow-sm transition-all duration-300 group-hover:scale-100 group-hover:opacity-100"
        style={{
          ...
          <p
            ...
            data-version="v1"
            style={customStyle}>
            <span className="sr-only">You: </span> I'd like to know what Vercel is
          </p>
          <svg
            aria-hidden="true"
            className="tail_hideDark__Wdafy absolute bottom-[-3px] left-[-7px]"
            fill="none"
            height="24"
            viewBox="0 0 24 24"
            width="24"
          ...
          >
            <path d="M0 0H24V24H0z" fill="var(--ds-background-200)"></path>
            <mask
              height="24"
              id="a"
          ...
          <svg
            ...
            xmlns="http://www.w3.org/2000/svg"
          >
            <rect fill="var(--ds-background-200)" height="24" width="24"></rect>
            <mask
              height="24"
              id="mask0_1762_12230"
              maskUnits="userSpaceOnUse"
