    ...
    <section className="relative w-full h-[50vh] md:h-[70vh] sm:h-[50vh] flex items-center justify-center overflow-hidden">
      ...
      <div className="absolute hidden md:block inset-0 z-10 pointer-events-none">
        ...
        <div className="floating-skill-bubble absolute top-16 right-8 animate-float-right">
          <div className="bg-gradient-to-r from-green-600 to-emerald-600 text-white px-2 py-3 md:px-4 md:py-2 rounded-full text-sm font-medium shadow-lg relative group flex items-center gap-2">
        ...
        <div className="floating-skill-bubble absolute bottom-16 left-8 animate-float-left">
          <div className="bg-gradient-to-r from-yellow-500 to-amber-600 text-white px-2 py-3 md:px-4 md:py-2 rounded-full text-sm font-medium shadow-lg relative group flex items-center gap-2">
            {/* <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 24 24">
        ...
        <div className="floating-skill-bubble absolute bottom-16 right-8 animate-float-right">
          <div className="bg-gradient-to-r from-blue-700 to-indigo-700 text-white px-2 py-3 md:px-4 md:py-2 rounded-full text-sm font-medium shadow-lg relative group flex items-center gap-2">
            {/* <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 24 24">
        ...
        {/* <div className="floating-skill-bubble absolute top-1/4 left-1/4 animate-float-left">
          <div className="bg-gradient-to-r from-green-700 to-teal-700 text-white px-2 py-3 md:px-4 md:py-2 rounded-full text-sm font-medium shadow-lg relative group flex items-center gap-2">
            <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 24 24">
        ...
        <div className="floating-skill-bubble absolute bottom-48 right-16 animate-float-right">
          <div className="bg-gradient-to-r from-gray-800 to-black text-white px-2 py-3 md:px-4 md:py-2 rounded-full text-sm font-medium shadow-lg relative group">
            Next.js
            <div className="absolute bottom-full right-0 mb-2 px-3 py-2 bg-gray-900 text-white text-xs rounded-lg opacity-0 group-hover:opacity-100 transition-opacity duration-300 pointer-events-auto whitespace-nowrap z-50">
              2+ years experience
              <div className="absolute top-full right-4 w-0 h-0 border-l-4 border-r-4 border-t-4 border-transparent border-t-gray-900"></div>
        ...
        <div className="floating-skill-bubble absolute top-1/3 right-16 animate-float-right">
          <div className="bg-gradient-to-r from-purple-500 to-pink-500 text-white px-2 py-3 md:px-4 md:py-2 rounded-full text-sm font-medium shadow-lg relative group">
            Data Engineering
            <div className="absolute bottom-full right-0 mb-2 px-3 py-2 bg-gray-900 text-white text-xs rounded-lg opacity-0 group-hover:opacity-100 transition-opacity duration-300 pointer-events-auto whitespace-nowrap z-50">
              4+ years experience
              <div className="absolute top-full right-4 w-0 h-0 border-l-4 border-r-4 border-t-4 border-transparent border-t-gray-900"></div>
        ...
        <div className="floating-skill-bubble absolute bottom-1/3 left-16 animate-float-left">
          <div className="bg-gradient-to-r from-red-500 to-pink-500 text-white px-2 py-3 md:px-4 md:py-2 rounded-full text-sm font-medium shadow-lg relative group">
            ML/AI
            <div className="absolute bottom-full left-1/2 transform -translate-x-1/2 mb-2 px-3 py-2 bg-gray-900 text-white text-xs rounded-lg opacity-0 group-hover:opacity-100 transition-opacity duration-300 pointer-events-auto whitespace-nowrap z-50">
              3+ years experience
              <div className="absolute top-full left-1/2 transform -translate-x-1/2 w-0 h-0 border-l-4 border-r-4 border-t-4 border-transparent border-t-gray-900"></div>
        ...
        {/* <div className="floating-skill-bubble absolute top-16 left-1/3 animate-float-left">
          <div className="bg-gradient-to-r from-blue-600 to-cyan-600 text-white px-2 py-3 md:px-4 md:py-2 rounded-full text-sm font-medium shadow-lg relative group">
            Docker
            <div className="absolute bottom-full left-1/2 transform -translate-x-1/2 mb-2 px-3 py-2 bg-gray-900 text-white text-xs rounded-lg opacity-0 group-hover:opacity-100 transition-opacity duration-300 pointer-events-auto whitespace-nowrap z-50">
              3+ years experience
              <div className="absolute top-full left-1/2 transform -translate-x-1/2 w-0 h-0 border-l-4 border-r-4 border-t-4 border-transparent border-t-gray-900"></div>
        ...
        <div className="floating-skill-bubble absolute top-1/4 left-8 animate-float-left">
          <div className="bg-gradient-to-r from-orange-500 to-red-600 text-white px-2 py-3 md:px-4 md:py-2 rounded-full text-xs md:text-sm font-medium shadow-lg relative group">
            AWS
            <div className="absolute bottom-full left-1/2 transform -translate-x-1/2 mb-2 px-3 py-2 bg-gray-900 text-white text-xs rounded-lg opacity-0 group-hover:opacity-100 transition-opacity duration-300 pointer-events-auto whitespace-nowrap z-50">
              2+ years experience
              <div className="absolute top-full left-1/2 transform -translate-x-1/2 w-0 h-0 border-l-4 border-r-4 border-t-4 border-transparent border-t-gray-900"></div>
        ...
        <div className="floating-skill-bubble absolute bottom-1/4 right-8 animate-float-right">
          <div className="bg-gradient-to-r from-red-600 to-orange-500 text-white px-2 py-3 md:px-4 md:py-2 rounded-full text-xs md:text-sm font-medium shadow-lg relative group">
            Redis
            <div className="absolute bottom-full right-0 mb-2 px-3 py-2 bg-gray-900 text-white text-xs rounded-lg opacity-0 group-hover:opacity-100 transition-opacity duration-300 pointer-events-auto whitespace-nowrap z-50">
              2+ years experience
              <div className="absolute top-full right-4 w-0 h-0 border-l-4 border-r-4 border-t-4 border-transparent border-t-gray-900"></div>
